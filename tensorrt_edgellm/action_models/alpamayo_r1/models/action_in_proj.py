...
"""
Copied from https://github.com/NVlabs/alpamayo/blob/2d2b511ccd626b97aab0c9c211861c0e768551aa/src/alpamayo_r1/models/action_in_proj.py
"""
...
class PerWaypointActionInProjV2(torch.nn.Module):
    ...
    def __init__(
        ...
        self.timestep_fourier_encoder = FourierEncoderV2(dim=num_fourier_feats,
                                                         max_freq=max_freq)
        num_input_feats = sum(
            s.out_dim
