...
"""
Adapted from https://github.com/NVlabs/alpamayo/blob/2d2b511ccd626b97aab0c9c211861c0e768551aa/src/alpamayo_r1/diffusion/flow_matching.py to combine the FlowMatching class with the BaseDiffusion base class.
"""
...
class FlowMatching(nn.Module):
    ...
    def _euler(
        ...
        for i in range(inference_step):
            ...
            t_start = time_steps[i].view(1, *[1] * n_dim).expand(
                batch_size, *[1] * n_dim)
