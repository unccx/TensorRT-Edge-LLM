...
"""
Qwen3-VL LLM backbone.

The Qwen3-VL text decoder is a standard Qwen3 transformer. The default
...
"""
from ..default.modeling_default import CausalLM as Qwen3VLLanguageModel

__all__ = ["Qwen3VLLanguageModel"]
